/* eslint quotes: 0 */
export default {
	activitiesAvailable: "Las actividades que vencen o terminan pronto están completadas. Marque Ver todos los trabajos para saber lo que viene más tarde.", // 'Empty View' - When widget has no activities to display within the next two weeks, but there are more activities further into the future that can be shown on the full screen view
	...
	noActivities: 'No tiene actividades con fecha de vencimiento o finalización disponibles.', // 'Empty state' - When widget has no activities in full page view
	noActivitiesName: '{firstName} no tiene actividades con fecha de vencimiento o final disponibles.', // 'Empty state' - When widget has no activities in full page view, when we want to show the user's name instead of referring to them as "you"
	noActivitiesNameless: 'No tiene actividades con fecha de vencimiento o final disponibles.', // 'Empty state' - When widget has no activities in full page view, when we want to refer to the user in the third person but don't know their name
	noActivitiesFutureActivities: "No tiene actividades que venzan o finalicen pronto. Vuelva más tarde o vea todos los trabajos para saber lo que viene a continuación.",  // 'Empty View' - When widget has no activities to display within the next few weeks & there are activities in the future
	noActivitiesFutureActivitiesName: "{firstName} no tiene actividades pendientes o que finalicen pronto. Vuelva más tarde o vea todos los trabajos para saber lo que viene a continuación.", // Shown under the same conditions as noActivitiesFutureActivities, when we want to show the user's name instead of referring to them as "you"
	noActivitiesFutureActivitiesNameless: "No tiene actividades pendientes o que finalicen pronto. Vuelva más tarde o vea todos los trabajos para saber lo que viene a continuación.", // Shown under the same conditions as noActivitiesFutureActivities, when we want to refer to the user in the third person but don't know their name
	noActivitiesNoFutureActivities: 'No tiene actividades con fecha de vencimiento o finalización disponibles. Vuelva más tarde para ver si tiene trabajo pendiente.', // 'Empty View' - When widget has no activities to display within the next few weeks & there are no more activities in the future
	noActivitiesNoFutureActivitiesName: '{firstName} no tiene actividades con fecha de vencimiento o final disponibles. Vuelva más tarde para ver si {firstname} tiene trabajo pendiente.', // Shown under the same conditions as noActivitiesNoFutureActivities, when we want to show the user's name instead of referring to them as "you"
	noActivitiesNoFutureActivitiesNameless: 'No tiene actividades con fecha de vencimiento o final disponibles. Vuelva más tarde para ver si tiene trabajo pendiente.', // Shown under the same conditions as noActivitiesNoFutureActivities, when we want to refer to the user in the third person but don't know their name
	...
	dueWithDate: 'Fecha de vencimiento {dueDate}', // show due Date on status indicator when an activity due in the future - formatted like "Due Aug 15"
	endWithDate: 'Fecha de finalización {endDate}' // show end Date on status indicator when an activity end in the future - formatted like "End Aug 15"
};
