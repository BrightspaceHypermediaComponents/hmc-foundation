/* eslint quotes: 0 */
export default {
	activitiesAvailable: "Mae gweithgareddau sy'n ddyledus neu'n dod i ben yn fuan wedi’u cwblhau! Gwiriwch Gweld Pob Darn o Waith i weld beth sy'n dod yn nes ymlaen.", // 'Empty View' - When widget has no activities to display within the next two weeks, but there are more activities further into the future that can be shown on the full screen view
	...
	noActivitiesName: 'Nid oes gan {firstName} unrhyw weithgareddau gyda dyddiadau dyledus neu ddyddiadau gorffen ar gael.', // 'Empty state' - When widget has no activities in full page view, when we want to show the user's name instead of referring to them as "you"
	noActivitiesNameless: 'Nid oes unrhyw weithgareddau gyda dyddiadau dyledus neu ddyddiadau gorffen ar gael.', // 'Empty state' - When widget has no activities in full page view, when we want to refer to the user in the third person but don't know their name
	...
	noActivitiesFutureActivitiesName: "Nid oes gan {firstName} unrhyw weithgareddau dyledus neu sy'n dod i ben yn fuan. Dewch yn ôl yn nes ymlaen neu Gweld Pob Darn o Waith i weld beth sy'n dod nesaf.", // Shown under the same conditions as noActivitiesFutureActivities, when we want to show the user's name instead of referring to them as "you"
	noActivitiesFutureActivitiesNameless: "Nid oes unrhyw weithgareddau dyledus neu sy'n dod i ben yn fuan. Dewch yn ôl yn nes ymlaen neu Gweld Pob Darn o Waith i weld beth sy'n dod nesaf.", // Shown under the same conditions as noActivitiesFutureActivities, when we want to refer to the user in the third person but don't know their name
	...
	noActivitiesNoFutureActivitiesName: 'Nid oes gan {firstName} unrhyw weithgareddau gyda dyddiadau dyledus neu ddyddiadau gorffen ar gael. Dewch yn ôl yn nes ymlaen i weld os oes gan {firstName} waith i'w wneud.', // Shown under the same conditions as noActivitiesNoFutureActivities, when we want to show the user's name instead of referring to them as "you"
	...
	dueWithDate: 'Yn ddyledus ar {dueDate}', // show due Date on status indicator when an activity due in the future - formatted like "Due Aug 15"
	endWithDate: 'Yn gorffen ar {endDate}' // show end Date on status indicator when an activity end in the future - formatted like "End Aug 15"
};
