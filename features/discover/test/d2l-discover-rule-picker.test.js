	...
	describe('interaction', () => {
		...
		for (const test of deletionTests) {
			it(test.description, async() => {
				...
				const conditionAnimatorList = el.shadowRoot.querySelectorAll('.d2l-picker-rule-animator');
				await oneEvent(conditionAnimatorList[test.index], 'd2l-animate-complete');
