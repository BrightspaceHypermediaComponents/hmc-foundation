...
export default {
	...
	"label-checkbox": "在「探索」中提供此課程，讓學習者可以自助註冊", // label for the discover checkbox
	"label-condition-type": "條件類型", // label for screen readers for the condition type select box
	...
	"text-rule-matches-card": "符合 {count} 位使用者", // Information about how many users a rule matches on a card
	...
	"text-title": "探索", // The title for Discover options
};
