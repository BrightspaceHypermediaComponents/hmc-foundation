...
export default {
	...
	"button-done": "Hecho", // done button to commit changes
	"label-checkbox": "Ponga este curso a disposición en Descubrir para que los estudiantes se puedan autoinscribir", // label for the discover checkbox
	"label-condition-type": "Tipo de condición", // label for screen readers for the condition type select box
	...
	"text-condition-placeholder": "Introducir un valor de condición", // Placeholder text for condition value input
	...
	"text-rules-description": "Para autoinscribirse en este curso, los usuarios deben cumplir con una o más de estas reglas.", // description for enrollment rules
	...
	"text-title": "Descubrir", // The title for Discover options
};
