/* eslint quotes: 0 */
export default {
	"button-cancel": "Annuller", // cancel button to trash changes
	"button-done": "Udført", // done button to commit changes
	"label-checkbox": "Gør dette kursus tilgængelig under Registrer, så elever selv kan tilmelde sig", // label for the discover checkbox
	"label-condition-type": "Betingelsestype", // label for screen readers for the condition type select box
	...
	"text-title": "Registrer", // The title for Discover options
};
