...
class ActivityEditorType extends RtlMixin(HypermediaLitMixin(LitElement)) {
...
customHypermediaElement('d2l-activity-editor-type', ActivityEditorType, null, 'assignment');
